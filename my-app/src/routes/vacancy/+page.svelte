<script>
    ...
    const endpoint = "http://localhost:8080/tutor";
    let data;
    ...
    <form  on:submit|preventDefault={go}>
        <div class="in1">
            ...
            <div class="ww">
                ...
                <p><input type="text" size="40" placeholder="Юриспруденция, экономика и т.д." id="discipline" bind:value={discipline}></p>
            </div>
            <div class="ww">
                <p class="shrift3 unde">Расскажите о себе</p>
                <p><textarea cols="80" rows="8" placeholder="Город, опыт работы, выполненяемые типы работ и т.д." id="description" bind:value={description}></textarea></p>
            </div>
            <div class="ww">
                <p class="shrift3">Прикрепите резюме</p>
